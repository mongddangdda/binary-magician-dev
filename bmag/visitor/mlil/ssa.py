...
class MediumLevelILSsaVisitor(MediumLevelILVisitor):

    def visit_MLIL_SET_VAR_SSA(self, expr: MediumLevelILSetVarSsa, *args, **kwargs):
        return self.visit_MLIL(expr, *args, **kwargs)
    ...
    def visit_MLIL_SSA(self, expr: MediumLevelILInstruction, *args, **kwargs):
